...
published: true
cover: ./cover.jpg
coverCredit: Photo by Marc-Olivier Jodoin on Unsplash
---
...
There are three major changes that should draw your attention in the second version of `foo`:
...
3. Each time the function calls itself, it provids a new value for the argument.
